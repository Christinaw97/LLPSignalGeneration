...
# with command line options: NANO -s PAT,NANO --data --conditions 150X_dataRun3_Prompt_v1 --era Run3 --eventcontent NANOAOD --datatier NANOAOD --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=1000 -n -1 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/uscms_data/d3/christiw/Run3_MDS/private_generation/Summer25/MDSNANO/CMSSW_15_0_10/src/2403063f-06c2-498f-877a-4ed1ff448dc9.root'),
...
process.NANOAODoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('NANO_PAT_NANO.root'),
